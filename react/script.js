...
/*const users = [
  ...
  */
  ...
  // const [first, second, third] = ["Amber", "Suze", "Suzanne"];

  /*const ingredients = [first = "Flour", second = "Butter", third = "Shortening", fourth = "Salt", fifth = "Baking Powder"];
...
const furniture = [fur1, , fur3] = ["Chair","Rug", "High-Chair"];
